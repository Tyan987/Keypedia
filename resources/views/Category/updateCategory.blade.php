...
<body style="background-color: #79A3B1">
  ...
  <div style="background-color: #D0E8F2; margin-left: 25vw; margin-top: 20vh" class="w-50 h-75 ">
    <h4 class="mb-3 d-flex justify-content-center" style="padding-top: 2vh; color: #456268">Update Category</h4>
    <hr>
        ...
        <div class="container">
            ...
            <div class="row pt-1">
                <div class="col-4 pb-4 px-3">
                    <img src="{{ Storage::url($category->image)}}" class="card-img-top" alt="IMG not found">
                </div>
                <div class="col-8">
                    <div class="row mb-3">
                        <label for="inputCategoryName" class="col-sm-4 col-form-label text-end">Category Name</label>
                        <div class="col-sm-6 ms-2">
                            <input type="text" class="form-control" style="background-color: #FCF8EC" name ="name" id="inputCategoryName" value="{{$category->name}}" aria-describedby="inputCategoryName">
                        </div>
                    </div>
    
                    <div class="row mb-5">
                        <label for="inputKeyboardImage" class="col-sm-4 col-form-label text-end">Category Image</label>
                        <div class="col-sm-6 ms-2">
                            <input class="form-control" type="file" name="image" style="background-color: #FCF8EC" id="image">
                        </div>
                    </div>
        
                    <div class="row mb-3">
                        <div class="col-sm-4"></div>
                        <div class="col-sm-6 mb-5 ms-2">
