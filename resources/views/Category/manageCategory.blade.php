...
<body style="background-color: #79A3B1" class="w-100 d-flex justify-content-center flex-column align-items-center">
  ...
  <div style="margin-top: 3vh; margin-bottom: 15vh" class="w-75 h-75 ">
    <h3 class="mb-3 fs-2 d-flex justify-content-center" style="padding-top: 3vh; color: #456268">Manage Categories</h3>
    <hr>

    <div class="card-deck d-flex justify-content-center w-100 flex-wrap">
      @foreach ($categories as $cat)
      <div class="card mb-3 m-3 text-center py-3 px-3" style="padding-top: 4vh; color: #456268; background-color: #D0E8F2; width:30%; border-radius: 25px">
        ...
        <div class="card-body">
            ...
            <div class="d-grid gap-2">
              <a class="btn btn-primary" type="button" style="background-color: #456268" href="/deleteCategory/{{$cat->id}}">Delete Categories</a>
              <a class="btn btn-primary" type="button" style="background-color: #456268" href="/updateCategory/{{$cat->id}}">Update Categories</a>
            </div>
