...
<head>
    ...
    <title>Update Keyboard Page</title>
</head>
<body style="background-color: #79A3B1">
  <header>
    ...
    <div style="background-color: #D0E8F2; margin-left: 25vw; margin-top: 7vh" class="w-50 h-75 ">
        <h4 class="mb-3 d-flex justify-content-center" style="padding-top: 2vh; color: #456268">Update Keyboard</h4>
        <hr>

        <form action="/updateKeyboard/{{$keyboard->id}}" method="POST">
          @csrf
          ...
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-4">
                      <img src="{{ Storage::url($keyboard->image)}}" class="card-img-top" alt="IMG not found">
                  </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-sm-6 ms-2">
                              <input type="text" value="{{$keyboard->name}}" name="name" class="form-control" style="background-color: #FCF8EC" id="inputKeyboardName" aria-describedby="inputKeyboardName">
                          </div>
                      </div>

                      <div class="row mb-3">
                          <label for="inputKeyboardPrice" class="col-sm-4 col-form-label text-end">Keyboard Price (USD)</label>
                          <div class="col-sm-6 ms-2">
                              <input type="number" value="{{$keyboard->price}}" name="price" class="form-control" id="inputKeyboardPrice" aria-describedby="inputKeyboardPrice" style="background-color: #FCF8EC">
                          </div>
                      </div>
                      ...
                      <div class="row mb-2">
                          ...
                          <div class="col-sm-6 ms-2">
                              <textarea class="form-control" value="{{$keyboard->description}}" name="description" id="textareaDescription" style="background-color: #FCF8EC" aria-describedby="textareaDescription"></textarea>
                          </div>
                      </div>
                      ...
                      <div class="row mb-4">
                          ...
                          <div class="col-sm-6 ms-2">
                              <input class="form-control" value="{{$keyboard->image}}" type="file" name="image" style="background-color: #FCF8EC" id="formFile">
                          </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-5 mb-5 ms-2">
                            <button type="submit" class="btn btn-primary" style="background-color: #456268">Update</button>
                        </div>
                    </div>
                  </div>
              </div>
